...
var addressLabels = []string{
	"фактический адрес проживания клиента", "фактическое место проживания", "место регистрации заявителя", "место регистрации клиента", "адрес регистрации заявителя", "адрес заявителя", "доставка клиенту по адресу", "адрес проживания клиента", "новый адрес доставки", "почтовый адрес физлица", "адрес доставки клиента", "адрес доставки", "клиент живёт по адресу", "клиент живет по адресу", "клиент живёт в", "клиент живет в",
