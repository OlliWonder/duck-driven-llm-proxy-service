...
var cardHolderLabels = []string{
	"на карте указано имя", "имя на банковской карте", "cardholder name", "card_holder", "имя держателя банковской карты", "имя держателя карты", "имя владельца карты", "держатель банковской карты", "держатель карты", "владелец карты", "имя держателя",
