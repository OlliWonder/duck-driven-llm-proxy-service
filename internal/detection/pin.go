...
var pinLabels = []string{"в поле pin указано", "код pin клиента", "пин-код клиента", "пин код клиента", "пин-код карты", "пин код карты", "пин карты", "pin карты", "пин-код", "пин код", "пин", "pin"}
