...
var citizenshipLabels = []string{
	"сведения о гражданстве клиента", "сведения о гражданстве", "гражданство",
	"гражданином", "гражданин", "гражданкой", "гражданка", "подданство", "nationality",
}
